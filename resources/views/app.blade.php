					...
					<div class="row">
						...
						<div class="large-8 columns" align="center">
							<div class="row">
								...
								<div class="large-6 columns small-4 columns"><a class="button radius" href="/auth/register">Register</a></div>
								@else
								<div class="large-6 columns small-4 columns hide-for-small"></div>
								<div class="large-6 columns small-4 columns">
									<a href="#" class="button radius" data-dropdown="hover1" data-options="is_hover:true; hover_timeout:5000">{{ Auth::user()->name }}</a>
