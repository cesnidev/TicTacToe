        ...
        <div class="container">
			<div class="header row" style="border-bottom: 3px solid #dc222b;" >
				<div class="large-4 columns">
					{!! Html::decode(Html::link('/',Html::image('img/logo4.png',null,array('style'=>'width:100%;margin-top:10px;')))) !!}
				</div>
...
<div id="eventicaforms">
			...
			<form id="experience" data-abide="ajax">
				...
				<div class="row">
								<div class="large-7 large-offset-1 columns">
									<div class="row">
										...
										<div class="large-5 columns" >
											<div class="row">
												<div class="large-4 small-4  columns"><p class="checktag tabcertified_no right">No</p></div>
												<div class="large-4 small-4  columns">
													<div class="switch">
												...
												<div class="large-4 small-4  columns"><p class="checktag tabcertified_yes left" style="display: none;">Yes</p></div>
											</div>
				...
				<div class="row" id="upload_tabc_" style="display:none;">
								<div class="large-7 large-offset-1 columns">
									<div class="row">
										<div class="large-7 columns">
											<label class="inline" disabled><font size="-1">Please upload license/permit?</font></label>
										</div>
										<div class="large-5 columns">
					...
					<div class="row">
								<div class="large-7 large-offset-1 columns">
									<div class="row">
										...
										<div class="large-5 columns" >
											<div class="row">
												<div class="large-4 small-4  columns"><p class="checktag xptech_no right">No</p></div>
												<div class="large-4 small-4  columns">
													<div class="switch">
												...
												<div class="large-4 small-4  columns"><p class="checktag xptech_yes left" style="display: none;">Yes</p></div>
											</div>
				...
				<div class="row">
								<div class="large-7 large-offset-1 columns">
									<div class="row">
										...
										<div class="large-5 columns" >
											<div class="row">
												<div class="large-4 small-4  columns"><p class="checktag cap_info_no right">No</p></div>
												<div class="large-4 small-4  columns">
													<div class="switch">
												...
												<div class="large-4 small-4  columns"><p class="checktag cap_info_yes left" style="display: none;">Yes</p></div>
											</div>
				...
				<div class="row">
								<div class="large-7 large-offset-1 columns">
									<div class="row">
										...
										<div class="large-5 columns" >
											<div class="row">
												<div class="large-4 small-4  columns"><p class="checktag xpsocial_no right">No</p></div>
												<div class="large-4 small-4  columns">
													<div class="switch">
												...
												<div class="large-4 small-4  columns"><p class="checktag xpsocial_yes left" style="display: none;">Yes</p></div>
											</div>
				...
				<div class="row">
					<div class="large-6 columns">
						<div class="row">
										...
										<div class="large-5 columns" >
											<div class="row">
												<div class="large-4 small-4  columns"><p class="checktag licensev_no right">No</p></div>
												<div class="large-4 small-4  columns">
													<div class="switch">
												...
												<div class="large-4 small-4  columns"><p class="checktag licensev_yes left" style="display: none;">Yes</p></div>
											</div>
											
										</div>
									
						</div>
						<div class="row center" id="upload_drivlic_" style="display:none;">
							<div class="row">
								<p >Please provide an image of your driver's license</p>
							</div>
							<div class="row">
						...
						<div class="row">
										...
										<div class="large-5 columns" >
											<div class="row">
												<div class="large-4 small-4  columns"><p class="checktag ownmb_no right">No</p></div>
												<div class="large-4 small-4  columns">
													<div class="switch">
												...
												<div class="large-4 small-4  columns"><p class="checktag ownmb_yes left" style="display: none;">Yes</p></div>
											</div>
						...
						<div class="row">
							...
							<div class="large-5 columns" >
								<div class="row">
									<div class="large-4 small-4  columns"><p class="checktag apitm_no right">No</p></div>
									<div class="large-4 small-4  columns">
										<div class="switch">
									...
									<div class="large-4 small-4  columns"><p class="checktag apitm_yes left" style="display: none;">Yes</p></div>
								</div>
				...
				<div class="row">
					<div class="large-4 columns">
						<div class="row">
									...
									<div class="large-10 small-10 columns left" >
			...
			<form id="legal" data-abide="ajax">
				...
				<div class="row">
							...
							<div class="large-4 columns" >
								<div class="row">
									<div class="large-4 small-4  columns"><p class="checktag answ1_no right">No</p></div>
									<div class="large-4 small-4  columns">
										<div class="switch round large">
									...
									<div class="large-4 small-4  columns"><p class="checktag answ1_yes left" style="display: none;">Yes</p></div>
								</div>
				...
				<div class="row">
					...
					<div class="large-4 columns" >
						<div class="row">
							<div class="large-4 small-4  columns"><p class="checktag answ2_no right">No</p></div>
							<div class="large-4 small-4  columns">
								<div class="switch round large">
							...
							<div class="large-4 small-4  columns"><p class="checktag answ2_yes left" style="display: none;">Yes</p></div>
						</div>
				...
				<div class="row">
					...
					<div class="large-4 columns" >
						<div class="row">
							<div class="large-4 small-4  columns"><p class="checktag legally_no right">No</p></div>
							<div class="large-4 small-4  columns">
								<div class="switch round large">
							...
							<div class="large-4 small-4  columns"><p class="checktag legally_yes left" style="display: none;">Yes</p></div>
						</div>
